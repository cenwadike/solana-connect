...
async function createTransferCheckedTransaction(
    ...
    const senderATA = await getOrCreateAssociatedTokenAccount( splToken, sender);
    ...
    const recipientATA = await getOrCreateAssociatedTokenAccount(mint.address, recipient);
