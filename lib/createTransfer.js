...
import { createTransferCheckedInstruction, getAccount, transfer, getMint, getOrCreateAssociatedTokenAccount } from '@solana/spl-token';
...
export async function transferDbaToDestinationAddress(transferAmount) {
    ...
    if (connected) {
    console.log("user wallet still connected: ", publicKey.value.toBase58())}
